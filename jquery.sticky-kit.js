...
(function() {
  ...
  $.fn.stick_in_parent = function(opts) {
    var elm, enable_bottoming, offset_top, parent_selector, scrollable_selector, sticky_class, _fn, _i, _len;
    if (opts == null) {
      opts = {};
    }
    ...
    _fn = function(elm, detached, fixed, bottomed) {
      var detach, parent, scrollable, tick, _top;
      ...
      tick = function() {
        var border_bottom, bottomed_old, fixed_old, margin_top, old, original_top, padding_bottom;
        if (detached) {
          return;
        }
        fixed_old = fixed;
